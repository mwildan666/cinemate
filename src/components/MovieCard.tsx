...
const MovieCard = ({ movie, showRating = true }: MovieCardProps) => {
  ...
  return (
    <Link
      to={`/movie/${movie.id}`}
      className="group block overflow-hidden rounded-lg bg-neutral-900 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black sm:hover:-translate-y-1"
    >
